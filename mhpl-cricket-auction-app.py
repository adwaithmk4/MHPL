...
EMBEDDED_PLAYERS = [
    ...
    },
    {
        ...
        "reg_num": "2502504016",
        "course": "B. Com(Hons) Financial analytics (2nd year)",
        "wicket_keeper": "No",
        "batting_style": "Left",
        "bowling_hand": "Right",
        "bowling_style": "Medium Fast",
...
with tab_arena:
    ...
    with col_c:
        ...
        if available_player_options:
            if st.button("🎲 Draw Random Player", use_container_width=True):
    ...
    if current_p is None:
        # Suggesting drawing a player
        st.info("No player currently on the bidding block! Draw a random player above or select one from the list below.")
        
        # Select player from dropdown list of available
        st.markdown("### Select Player to Bring onto Bidding Block:")
        if available_player_options:
            ...
            if st.button("Bring to Auction Block"):
